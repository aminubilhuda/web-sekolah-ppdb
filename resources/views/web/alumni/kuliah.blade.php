...
@section('title', 'Alumni Kuliah')
@section('meta_description', 'Profil alumni yang sedang kuliah')

@section('content')
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Alumni Kuliah</h1>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        @forelse($kuliah as $item)
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="mt-4">
                    <h3 class="font-medium text-gray-900">Data Kuliah:</h3>
                    <div class="mt-2 text-gray-600">
                        <p><span class="font-medium">Kampus:</span> {{ $item->nama_kampus }}</p>
                        <p><span class="font-medium">Jurusan:</span> {{ $item->jurusan_kuliah }}</p>
                        <p><span class="font-medium">Tahun Masuk:</span> {{ $item->tahun_masuk }}</p>
                    </div>
                </div>
                <div class="mt-4">
        ...
        <div class="col-span-3 text-center py-12">
            <p class="text-gray-500">Belum ada data alumni yang kuliah.</p>
        </div>
        @endforelse
    </div>

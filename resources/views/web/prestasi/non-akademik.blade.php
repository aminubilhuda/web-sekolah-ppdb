...
@section('meta_description', 'Prestasi-prestasi non-akademik yang telah diraih oleh siswa dan sekolah kami')

@section('content')
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Prestasi Non-Akademik</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="col-span-3 text-center py-12">
            <p class="text-gray-500">Belum ada prestasi non-akademik yang ditambahkan.</p>
        </div>
        @endforelse
    </div>

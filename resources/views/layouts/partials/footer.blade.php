        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-400 mb-4">
                    Sekolah Menengah Kejuruan yang berfokus pada pengembangan kompetensi siswa dalam bidang teknologi dan industri.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-center">
                        ...
                        <span class="text-gray-400">Jl. Pendidikan No. 123, Kota</span>
                    </li>
                    <li class="flex items-center">
                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="flex items-center">
                        ...
                        <span class="text-gray-400">info@sekolah.sch.id</span>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <form class="flex">
                    <input type="email" placeholder="Email Anda" class="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary-500">
